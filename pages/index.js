...
export default function Home() {
  return (
    <div >
      <Head>
        <title>Baggify - Shop Online</title>
        <meta name="description" content="Baggify - Shop Online" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Shop online in just one click with Baggify.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">We make online selling superbly easy.</p>
    </div>
